            ...
            <div className="flexpadre">
                ...
                <div className="flex">
                    ...
                    <Modal isOpen={this.state.modalEditar}>
                        ...
                        <ModalBody>
                            < FormGroup>
                                ...
                                <input value={this.state.form.NroPedido} className="form-control" readOnly type="text" />
                            </FormGroup>

                            < FormGroup>
                                <label>Fecha:</label>
                                <input value={this.state.form.Fecha} onChange={this.handleChange} className="form-control" name="Fecha" type="text" />
                            </FormGroup>

                            < FormGroup>
                                <label>Cliente:</label>
                                <input value={this.state.form.Cliente} onChange={this.handleChange} className="form-control" name="Cliente" type="text" />
                            </FormGroup>

                            < FormGroup>
                                <label>Producto:</label>
                                <input value={this.state.form.Producto} onChange={this.handleChange} className="form-control" name="Producto" type="text" />
                            </FormGroup>
                            < FormGroup>
                            ...
                            < FormGroup>
                                ...
                                <select value={this.state.form.Estado} id="inputState" className="form-select imput" name="Estado">
                                    <option>...</option>
                        ...
                        <ModalBody>
                            <div className="ID">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="#">Fabricacion</a></li>
                                        <li><a class="dropdown-item" href="#">Listo para la entrega</a></li>
                            ...
                            <div className="ID">
                                <div class="input-group mb-3">
                                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" >NroPedido</button>
                                    <input style={{ width: "10%" }} type="text" class="form-control" aria-label="Text input with dropdown button" />
                                </div>
                            </div>
                        </ModalBody>
                        <ModalFooter>
                    ...
                    <Modal size="lg" className="Modal" isOpen={this.state.modalReporte}>
                        <ModalHeader>
                            <div><h3>Reportes de Pedidos</h3></div>
                        </ModalHeader>
                        <ModalBody>
