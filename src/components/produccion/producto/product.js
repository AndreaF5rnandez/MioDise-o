                ...
                <div className="flex">
                    ...
                    <Modal isOpen={this.state.modalEditar}>
                        ...
                        <ModalBody>
                            ...
                            < FormGroup>
                                <label>Nombre:</label>
                                <input value={this.state.form.nombre} onChange={this.handleChange} className="form-control" name="Nombre" type="text" />
                            </FormGroup>
                            ...
                            < FormGroup>
                                ...
                                <input value={this.state.form.FIProduccion} className="form-control" name="FIProduccion" type="text" />
                            </FormGroup>
                            < FormGroup>
                                <label>FFProduccion:</label>
                                <input value={this.state.form.FFProduccion} className="form-control" name="FFProduccion" type="text" />
                            </FormGroup>
